...
const Contact = () => {
  ...
  return (
    <section id="contact" className='pt-24 text-center zm-auto'>
      <div className='mx-5 md:flex'>
        <article className='rounded-t-md md:rounded-l-md p-5 section-color'>
          <div className="contact-form ">
            ...
            <form name="contact" ref={form} onSubmit={sendEmail}>
              ...
              <label htmlFor="message" className='m-auto col-span-2'>
                Mensaje
                <textarea name="message" id="" cols="30" rows="10" placeholder='Su mensaje'></textarea>
              </label>
        ...
        <article className="contact-info p-2 bg-primary-color rounded-b-md md:rounded-r-md">
